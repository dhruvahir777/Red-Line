  ...
  return (
    <div className="flex flex-col items-center justify-between w-20 md:w-24 h-full py-4 md:py-8 pl-2 md:pl-4 shrink-0 z-40 bg-nexus-bg/50 backdrop-blur-sm md:bg-transparent">
      ...
      <div 
        ...
        className="w-10 h-10 md:w-12 md:h-12 bg-nexus-text rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-8 shadow-glow shrink-0 group cursor-pointer"
      >
        <span className="text-nexus-bg font-black text-lg md:text-xl group-hover:scale-110 transition-transform">RL</span>
      </div>
